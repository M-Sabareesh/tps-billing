...
class Item(models.Model):
    ...
    item_weight = models.DecimalField(max_digits=12, decimal_places=2)
    net_weight = models.DecimalField(max_digits=12, decimal_places=2)
    making_charges_percentage = models.DecimalField(max_digits=12, decimal_places=2)
    making_charges = models.DecimalField(max_digits=12, decimal_places=2)
    stone_price = models.DecimalField(max_digits=12, decimal_places=2)
    unit_price = models.DecimalField(max_digits=12, decimal_places=2)
    net_amount = models.DecimalField(max_digits=12, decimal_places=2)
    vat_percentage = models.DecimalField(max_digits=12, decimal_places=2)
    vat_rate = models.DecimalField(max_digits=12, decimal_places=2)
